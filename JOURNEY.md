...
| ch4 | 4.2 메트릭 모니터링 | ✅ | 2026-07-15 | kube-prometheus-stack 설치, Grafana UI 접속, Prometheus 수집 확인(16/18 타겟 up), Notiflex 전용 대시보드(CPU/메모리/재시작) 생성 완료. HTTP 요청 수 패널은 앱에 /metrics 미노출로 보류 |
